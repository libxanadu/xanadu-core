...
_XCOREAPI_ void __xcall__ sha256_compile(XANADU_CORE_SHA256_CONTEXT ctx[1])
{
...
_XCOREAPI_ void __xcall__ sha256_hash(const unsigned char data[], unsigned long len, XANADU_CORE_SHA256_CONTEXT ctx[1])
{
...
static void sha_end1(unsigned char hval[], XANADU_CORE_SHA256_CONTEXT ctx[1], const unsigned int hlen)
{
...
_XCOREAPI_ void __xcall__ sha256_begin(XANADU_CORE_SHA256_CONTEXT ctx[1])
{
	memset(ctx, 0, sizeof(XANADU_CORE_SHA256_CONTEXT));
	memcpy(ctx->hash, i256, sizeof(ctx->hash));
}

_XCOREAPI_ void __xcall__ sha256_end(unsigned char hval[], XANADU_CORE_SHA256_CONTEXT ctx[1])
{
...
{
	XANADU_CORE_SHA256_CONTEXT  cx[1];
...
{
	li_64(428a2f98d728ae22),
	li_64(7137449123ef65cd),
	li_64(b5c0fbcfec4d3b2f),
	li_64(e9b5dba58189dbbc),
	li_64(3956c25bf348b538),
	li_64(59f111f1b605d019),
	li_64(923f82a4af194f9b),
	li_64(ab1c5ed5da6d8118),
	li_64(d807aa98a3030242),
	li_64(12835b0145706fbe),
	li_64(243185be4ee4b28c),
	li_64(550c7dc3d5ffb4e2),
	li_64(72be5d74f27b896f),
	li_64(80deb1fe3b1696b1),
	li_64(9bdc06a725c71235),
	li_64(c19bf174cf692694),
	li_64(e49b69c19ef14ad2),
	li_64(efbe4786384f25e3),
	li_64(0fc19dc68b8cd5b5),
	li_64(240ca1cc77ac9c65),
	li_64(2de92c6f592b0275),
	li_64(4a7484aa6ea6e483),
	li_64(5cb0a9dcbd41fbd4),
	li_64(76f988da831153b5),
	li_64(983e5152ee66dfab),
	li_64(a831c66d2db43210),
	li_64(b00327c898fb213f),
	li_64(bf597fc7beef0ee4),
	li_64(c6e00bf33da88fc2),
	li_64(d5a79147930aa725),
	li_64(06ca6351e003826f),
	li_64(142929670a0e6e70),
	li_64(27b70a8546d22ffc),
	li_64(2e1b21385c26c926),
	li_64(4d2c6dfc5ac42aed),
	li_64(53380d139d95b3df),
	li_64(650a73548baf63de),
	li_64(766a0abb3c77b2a8),
	li_64(81c2c92e47edaee6),
	li_64(92722c851482353b),
	li_64(a2bfe8a14cf10364),
	li_64(a81a664bbc423001),
	li_64(c24b8b70d0f89791),
	li_64(c76c51a30654be30),
	li_64(d192e819d6ef5218),
	li_64(d69906245565a910),
	li_64(f40e35855771202a),
	li_64(106aa07032bbd1b8),
	li_64(19a4c116b8d2d0c8),
	li_64(1e376c085141ab53),
	li_64(2748774cdf8eeb99),
	li_64(34b0bcb5e19b48a8),
	li_64(391c0cb3c5c95a63),
	li_64(4ed8aa4ae3418acb),
	li_64(5b9cca4f7763e373),
	li_64(682e6ff3d6b2b8a3),
	li_64(748f82ee5defb2fc),
	li_64(78a5636f43172f60),
	li_64(84c87814a1f0ab72),
	li_64(8cc702081a6439ec),
	li_64(90befffa23631e28),
	li_64(a4506cebde82bde9),
	li_64(bef9a3f7b2c67915),
	li_64(c67178f2e372532b),
	li_64(ca273eceea26619c),
	li_64(d186b8c721c0c207),
	li_64(eada7dd6cde0eb1e),
	li_64(f57d4f7fee6ed178),
	li_64(06f067aa72176fba),
	li_64(0a637dc5a2c898a6),
	li_64(113f9804bef90dae),
	li_64(1b710b35131c471b),
	li_64(28db77f523047d84),
	li_64(32caab7b40c72493),
	li_64(3c9ebe0a15c9bebc),
	li_64(431d67c49c100d4c),
	li_64(4cc5d4becb3e42b6),
	li_64(597f299cfc657e2a),
	li_64(5fcb6fab3ad6faec),
	li_64(6c44198c4a475817)
};
...
_XCOREAPI_ void __xcall__ sha512_compile(XANADU_CORE_SHA512_CONTEXT ctx[1])
{
	std::uint64_t    v[8], *p = ctx->wbuf;
	std::uint32_t    j;
...
_XCOREAPI_ void __xcall__ sha512_hash(const unsigned char data[], unsigned long len, XANADU_CORE_SHA512_CONTEXT ctx[1])
{
...
static void sha_end2(unsigned char hval[], XANADU_CORE_SHA512_CONTEXT ctx[1], const unsigned int hlen)
{
...
{
	li_64(cbbb9d5dc1059ed8),
	li_64(629a292a367cd507),
	li_64(9159015a3070dd17),
	li_64(152fecd8f70e5939),
	li_64(67332667ffc00b31),
	li_64(8eb44a8768581511),
	li_64(db0c2e0d64f98fa7),
	li_64(47b5481dbefa4fa4)
};

_XCOREAPI_ void __xcall__ sha384_begin(XANADU_CORE_SHA384_CONTEXT ctx[1])
{
	memset(ctx, 0, sizeof(XANADU_CORE_SHA384_CONTEXT));
	memcpy(ctx->hash, i384, sizeof(ctx->hash));
}

_XCOREAPI_ void __xcall__ sha384_end(unsigned char hval[], XANADU_CORE_SHA384_CONTEXT ctx[1])
{
...
{
	XANADU_CORE_SHA384_CONTEXT  cx[1];
...
{
	li_64(6a09e667f3bcc908),
	li_64(bb67ae8584caa73b),
	li_64(3c6ef372fe94f82b),
	li_64(a54ff53a5f1d36f1),
	li_64(510e527fade682d1),
	li_64(9b05688c2b3e6c1f),
	li_64(1f83d9abfb41bd6b),
	li_64(5be0cd19137e2179)
};
...
static const uint64_t i512_256[SHA512_DIGEST_SIZE >> 3] =
{
	...
	li_64(96283ee2a88effe3),
	li_64(be5e1e2553863992),
	li_64(2b0199fc2c85b8aa),
	li_64(0eb72ddc81c52ca2),
};
...
{
	li_64(010176140648b233),
	li_64(db92aeb1eebadd6f),
	li_64(83a9e27aa1d5ea62),
	li_64(ec95f77eb609b4e1),
	li_64(71a99185c75caefa),
	li_64(006e8f08baf32e3c),
	li_64(6a2b21abd2db2aec),
	li_64(24926cdbd918a27f),
};
...
{
	li_64(c953a21464c3e8cc),
	li_64(06cc9cfd166a34b5),
	li_64(647e88dabf8b24ab),
	li_64(8513e4dc05a078ac),
	li_64(7266fcfb7cba0534),
	li_64(854a78e2ecd19b93),
	li_64(8618061711cec2dd),
	li_64(b20d8506efb929b1),
};

_XCOREAPI_ void __xcall__ sha512_begin(XANADU_CORE_SHA512_CONTEXT ctx[1])
{
	memset(ctx, 0, sizeof(XANADU_CORE_SHA512_CONTEXT));
	memcpy(ctx->hash, i512, sizeof(ctx->hash));
}

_XCOREAPI_ void __xcall__ sha512_256_begin(XANADU_CORE_SHA512_CONTEXT ctx[1])
{
	memset(ctx, 0, sizeof(XANADU_CORE_SHA512_CONTEXT));
	memcpy(ctx->hash, i512_256, sizeof(ctx->hash));
}

_XCOREAPI_ void __xcall__ sha512_224_begin(XANADU_CORE_SHA512_CONTEXT ctx[1])
{
	memset(ctx, 0, sizeof(XANADU_CORE_SHA512_CONTEXT));
	memcpy(ctx->hash, i512_224, sizeof(ctx->hash));
}

_XCOREAPI_ void __xcall__ sha512_192_begin(XANADU_CORE_SHA512_CONTEXT ctx[1])
{
	memset(ctx, 0, sizeof(XANADU_CORE_SHA512_CONTEXT));
	memcpy(ctx->hash, i512_192, sizeof(ctx->hash));
}

_XCOREAPI_ void __xcall__ sha512_128_begin(XANADU_CORE_SHA512_CONTEXT ctx[1])
{
	memset(ctx, 0, sizeof(XANADU_CORE_SHA512_CONTEXT));
	memcpy(ctx->hash, i512_128, sizeof(ctx->hash));
}

_XCOREAPI_ void __xcall__ sha512_end(unsigned char hval[], XANADU_CORE_SHA512_CONTEXT ctx[1])
{
	sha_end2(hval, ctx, SHA512_DIGEST_SIZE);
}

_XCOREAPI_ void __xcall__ sha512_256_end(unsigned char hval[], XANADU_CORE_SHA512_CONTEXT ctx[1])
{
	sha_end2(hval, ctx, SHA512_256_DIGEST_SIZE);
}

_XCOREAPI_ void __xcall__ sha512_224_end(unsigned char hval[], XANADU_CORE_SHA512_CONTEXT ctx[1])
{
	sha_end2(hval, ctx, SHA512_224_DIGEST_SIZE);
}

_XCOREAPI_ void __xcall__ sha512_192_end(unsigned char hval[], XANADU_CORE_SHA512_CONTEXT ctx[1])
{
	sha_end2(hval, ctx, SHA512_192_DIGEST_SIZE);
}

_XCOREAPI_ void __xcall__ sha512_128_end(unsigned char hval[], XANADU_CORE_SHA512_CONTEXT ctx[1])
{
...
{
	XANADU_CORE_SHA512_CONTEXT  cx[1];
...
_XCOREAPI_ int __xcall__ sha2_begin(unsigned long len, XANADU_CORE_SHA2_CONTEXT ctx[1])
{
	switch(len)
	{
#if defined(SHA_224)
...
_XCOREAPI_ void __xcall__ sha2_hash(const unsigned char data[], unsigned long len, XANADU_CORE_SHA2_CONTEXT ctx[1])
{
	switch(ctx->sha2_len)
	{
#if defined(SHA_224)
...
_XCOREAPI_ void __xcall__ sha2_end(unsigned char hval[], XANADU_CORE_SHA2_CONTEXT ctx[1])
{
	switch(ctx->sha2_len)
	{
#if defined(SHA_224)
